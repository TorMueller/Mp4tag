...
namespace Knuckleball
{
    ...
    public class MetadataTags : IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets the (HD) video quality for this file.
        /// </summary>
        public HDVideo HDVideo { get; set; }
        ...
        internal static MetadataTags ReadFromFile(IntPtr fileHandle)
        {
            ...
            managedTags.HDVideo = tags.HDVideo.ReadEnumValue<HDVideo>(HDVideo.NotSet);
        ...
        internal void WriteToFile(IntPtr fileHandle)
        {
            ...
            if (this.HDVideo != tags.HDVideo.ReadEnumValue<HDVideo>(HDVideo.NotSet))
            {
                byte? hdVideo = this.HDVideo == HDVideo.NotSet ? null : (byte?)this.HDVideo;
                tagsPtr.WriteByte(hdVideo, NativeMethods.MP4TagsSetHDVideo);
            }
